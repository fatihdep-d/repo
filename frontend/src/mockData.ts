export interface Project {
  ...
  const testimonials: Testimonial[] = [
    ...
    },
    {
      ...
      stars: 5,
      quote:
        "Belajar kelompok bareng Alif selalu asik. Dia pintar menjelaskan konsep pemrograman yang susah dengan bahasa yang gampang dimengerti oleh teman sekelas.",
    },
    {
      id: 3,
      name: "Siti Rahmawati",
      ...
      stars: 5,
      quote:
        "Pemahaman Alif terhadap framework Next.js dan Tailwind CSS v4 di usianya sekarang sangat mengagumkan. Proyek-proyeknya dikerjakan dengan sangat rapi.",
    },
  ];
