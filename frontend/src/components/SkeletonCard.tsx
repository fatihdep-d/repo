interface SkeletonCardProps {
  ...
  export default function SkeletonCard({
    ...
    if (variant === "testimonial") {
      return (
        <div className="p-6 sm:p-8 rounded-2xl bg-gray-900/40 border border-gray-800/40 animate-pulse flex flex-col justify-between h-77">
          <div>
        ...
        <div className="p-6 flex flex-col flex-1">
          ...
          <div className="flex gap-1.5 mb-6">
            {[1, 2, 3].map((i) => (
              <div
                key={i}
                className="h-6 bg-gray-800 rounded-md w-14"
              />
            ))}
          </div>
